...
// matters more than being readable. An empty string becomes ”, which
// is a real empty argument rather than nothing at all.
...
// would act on, returning it untouched otherwise.
//
